...
\begin{enumerate}
    ...
    \item \textbf{Aplicar los métodos de Ziegler-Nichols y Smith:} Se estimaron los parámetros del modelo a partir de la respuesta al escalón, obteniendo las variables \(K\), \(\theta\) y \(\tau\).
    
    \item \textbf{Simular la respuesta al escalón con el modelo FOPDT:} Se utilizó la función de transferencia para simular la respuesta del sistema considerando el tiempo muerto.
...
A partir de la comparación de los modelos FOPDT obtenidos con los métodos de Ziegler-Nichols y Smith, se observa lo siguiente:
