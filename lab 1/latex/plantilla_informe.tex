...
Adicionalmente, se analizó el escenario con \textbf{Q1 y Q2 encendidos simultáneamente}, enfocando la interpretación en la salida asociada a \textbf{Q1}. Este caso permite observar cómo el acoplamiento térmico modifica la forma de la respuesta respecto a las pruebas con una sola entrada activa.

\begin{figure}[h!]
        \centering
            \includegraphics[width=0.45\textwidth]{Q2_Q1-tangNich-Q1.png}
                \hfill
                    \includegraphics[width=0.45\textwidth]{Q2_Q1-smith-Q1.png}
                        \caption{Ajuste FOPDT para Q1 con Q1 y Q2 encendidos: Tangente/Ziegler-Nichols (izquierda) y Smith (derecha).}
\end{figure}

\begin{figure}[h!]
        \centering
            \includegraphics[width=0.7\textwidth]{Q2_Q1-comparacion-Q1.png}
                \caption{Comparación global de modelos para la salida Q1 en el escenario simultáneo Q1+Q2.}
\end{figure}

En estas gráficas se aprecia que ambos métodos reproducen la tendencia general de la dinámica térmica, pero con diferencias en el transitorio inicial y en el tiempo de establecimiento. El método de Tangente/Ziegler-Nichols suele capturar mejor la pendiente inicial, mientras que Smith puede ofrecer un ajuste más suave en la zona media de la respuesta. La comparación final permite identificar cuál representación se aproxima mejor al comportamiento medido cuando hay interacción entre ambos calentadores.
